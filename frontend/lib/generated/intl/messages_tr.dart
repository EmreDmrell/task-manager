...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "accountCreated": MessageLookupByLibrary.simpleMessage(
      "Hesap oluşturuldu. ŞİMDİ GİRİŞ YAPIN!",
    ),
    "addTask": MessageLookupByLibrary.simpleMessage("Yeni Görev Ekle"),
    "addTaskShowcase": MessageLookupByLibrary.simpleMessage(
      "Yeni görev eklemek için buraya dokun",
    ),
    ...
    "deleteTaskShowcase": MessageLookupByLibrary.simpleMessage(
      "Görevi silmek için sola kaydırın",
    ),
    ...
    "editTask": MessageLookupByLibrary.simpleMessage("Görevi Düzenle"),
    ...
    "selectColorforTask": MessageLookupByLibrary.simpleMessage(
      "Göreviniz için bir renk seçin",
    ),
    "selectDateShowcase": MessageLookupByLibrary.simpleMessage(
      "Görevleri tarihe göre filtrelemek için tarih seçin",
    ),
    "selectDueDateShowcase": MessageLookupByLibrary.simpleMessage(
      "Bitiş tarihini seçmek için dokun",
    ),
    "selectShade": MessageLookupByLibrary.simpleMessage("Farklı bir ton seçin"),
